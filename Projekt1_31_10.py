...
'''
1. musisz stworzyc przestrzen x'ów, przyda ci sie biblioteka numpy i funkcja arange
2. musisz zapisac funkcje G(x,y): 3x^7 + 2y^5 - x^3 + y^3 - 3
3. musisz zapisac fukcje G_prim(x,y) czyli pochodna funkcji G,
latwo bedzie jesli zrobisz to liczac pochodna z definicji czyli (G(x, y) - G(x, y-h))/h gdzie h to bardzo mala liczba np 10e-10
4. musisz zapisac funkcje 
'''